...
针对Eclipse构建的工程，UPSDK以`*.jar`的方式导入到工程中。UPSDK JavaScriptPlugin版本的下载包( [Android-LayaboxJsSDK下载](http://doc.upltv.com/en/master/chapters/chapter09.html "SDK下载页面"))解压后的目录结构如下：
