...
1.UPSDK Android [GDPR接口调用](http://docs.upltv.com/docs/show/195)

2.UPSDK IOS  [GDPR接口调用](http://docs.upltv.com/docs/show/194)

3.UPSDK UnityPlugin[GDPR接口调用](http://docs.upltv.com/docs/show/193)

4.UPSDK Cocos2d-x Cpp [GDPR接口调用](http://docs.upltv.com/docs/show/199)

5.UPSDK Cocos2d-x Lua [GDPR接口调用](http://docs.upltv.com/docs/show/210)

6.UPSDK Cocos2d-x JavaScript [GDPR接口调用](http://docs.upltv.com/docs/show/220)
